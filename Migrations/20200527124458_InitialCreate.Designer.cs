...
namespace EFCoreQueriesEspaciales.Migrations
{
    ...
    [Migration("20200527124458_InitialCreate")]
            ...
            modelBuilder.Entity("Restaurante", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Ciudad = "London",
                            Nombre = "Tower Bridge",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-0.1453961 51.5055424)")
                        });
                });
